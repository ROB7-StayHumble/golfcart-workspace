...
folder = "/home/zacefron/Desktop/golfcart-workspace/catkin_ws/src/persondetection/src/testing/"
...
for i,pair in enumerate(pairs):
    if i < 500:
        ...
        zed_yolo_img, zed_yolo_boxes = detect_from_img(zed.copy())
        ...
        plt.savefig(folder + "results/video/"+filename+"_zed.png", bbox_inches='tight')
        #
        # #IR image
        # fig = plt.figure(num=None, figsize=(12, 4), dpi=300)
        # plt.imshow(ir)
